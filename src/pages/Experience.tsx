  ...
  return (
    <section ref={sections.experience} className="flex flex-col items-center justify-center relative opacity-100 h-auto mx-auto xl:mb-[250px] py-4 px-12 sm:px-8 md:px-20 lg:px-0 lg:py-[120px]">
      <article className="w-full max-w-6xl">
        <h2 className="font-bold text-4xl lg:text-6xl 2xl:text-7xl leading-10 lg:leading-14 xl:leading-[70px] xs:text-left md:text-center bg-gradient-to-b dark:from-[#F4B400] dark:to-white bg-clip-text dark:text-transparent mt-12 mb-12 lg:mb-24">
          My career &
          <br /> experience
        </h2>
        <TimeLine
