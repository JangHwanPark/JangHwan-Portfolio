...
const TimeLine = forwardRef<HTMLDivElement, TimeLineProps>(({
  ...
  return (
    <div ref={ref} className="relative flex flex-col mx-auto">
      {/* 타임라인 선 */}
      <div ref={timelineRef} className="absolute top-[-50px] -left-3 md:-left-10 lg:left-1/2 transform -translate-x-1/2 w-[3px] h-full bg-gradient-to-t dark:from-[#F4B400] from-white-bg bg-[#F4B400] via-accent to-transparent"></div>

      {/* 타임라인 요소 */}
      <div ref={dotRef} className="absolute top-[-50px] left-1/2 transform -translate-x-1/2 dark:bg-[#ffd700] from-dark-bg bg-[#F4B400] w-[10px] h-[10px] rounded-full dark:shadow-[0_0_5px_2px_#ffd700,0_0_15px_8px_#ffcc00,0_0_110px_20px_#ffeb3b] shadow-[0_0_5px_2px_#F4B400,0_0_15px_8px_#ffcc00,0_0_110px_20px_#ffeb3b]"></div>
