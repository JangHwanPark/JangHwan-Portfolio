...
const TimeLine = forwardRef<HTMLDivElement, TimeLineProps>(({
  ...
  return (
    <div ref={ref} className="relative flex flex-col mx-auto">
      {/* 타임라인 선 */}
      <div ref={timelineRef} className="absolute top-[-50px] -left-3 md:-left-10 lg:left-1/2 transform -translate-x-1/2 w-[3px] h-full bg-gradient-to-t from-white-bg bg-[#F4B400] via-accent to-transparent"></div>
